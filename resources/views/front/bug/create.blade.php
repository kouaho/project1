         ...
         @include('front.front_layout.side')
          ...
          <div class="p-4" >
            @if ($errors->any())
              ...
              @endif
              <form method="POST" action="{{route('bug.index')}}" enctype="multipart/form-data">@csrf
                <div class="form-group fg-line">
                        <label for="exampleInputEmail1">Libelle du bug</label>
                        <input type="text" class="form-control input-sm" name="libelle" placeholder="Enter le libelle du bug" id="libelle">
                </div>
                <hr>
                <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                          <div class="form-group">
                            <label for="exampleFormControlSelect1">Resumé</label>
                            <textarea class="form-control" rows="5" name="resume" placeholder="">
                            </textarea>
                          </div>
                      </div>
                <hr>
                <div class="col-lg-12 col-md-12 col-xl-12 col-sm-">
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Description</label>
                         <textarea class="form-control" rows="5" name="description" placeholder="">
                        </textarea> <br>
                ...
                <div class="row"> 
                    ...
                    <button type="submit" class="btn btn-primary btn-lg pull-right " style="width: 200px; margin-right:10px; ">Sauvegarder</button>
