...
<html lang="en">
    ...
    <head>
        <base href="../../../">
        <meta charset="utf-8" />
        <title>Bugtrucker | Liste des Domaines</title>
                                    ...
                                    <div class="kt-portlet__head-toolbar">
                                        <div class="kt-portlet__head-wrapper">
                                            <div class="kt-portlet__head-actions">
                                                ...
                                                &nbsp;
                                                <a href="{{ route('domains.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                        ...
                                        <tbody>
                                            @foreach ($domains as $domain)
                                                <tr>
                                                    ...
                                                    <td> {{ substr($domain->description, 0, 58) }}</td>
                                                    <td class="pull-center">
                                                        <form action="{{ route('domains.destroy',$domain->id) }}" method="POST">
                                                            <a class="btn btn-info" href="{{ route('domains.show',$domain->id) }}"><i class="flaticon-eye "></i>Voir</a>
                                                            <a class="btn btn-primary" href="{{ route('domains.edit',$domain->id) }}"><i class="flaticon-edit " ></i>Modifier</a>
                                                         @csrf
