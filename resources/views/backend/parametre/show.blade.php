...
<html lang="en">
    ...
    <head>
        <base href="../../../">
        <meta charset="utf-8" />
        <title>Bugtrucker | {{$parametre->libelle}}</title>
                ...
                <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    ...
                                    <a class="btn btn-primary" style="width: 105px;"href="{{ route('parametre.index') }}"><i class="flaticon2-back-1"></i> Retour</a>
                                </div>
                                </div>
                                @if ($errors->any())
                                    <div class="kt-portlet__head">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="type" placeholder="Enter le type" value="{{$parametre->type}}">
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="libelle" placeholder="Enter le libelle" value="{{$parametre->libelle}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-9 col-sm-12">
                                                <textarea name="description" class="form-control" data-provide="markdown" rows="10">{{ $parametre->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" ">
                                            <div class="row">
                                                <div class="col-lg-9 ml-lg-auto">
                                                    <button type="submit" class="btn btn-success">Modifier<i class="flaticon2-checkmark"></i></button>
