...
<html lang="en">
    ...
    <head>
        <base href="../../../">
        <meta charset="utf-8" />
        <title>Bugrucker | Ajout de parametre</title>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                ...
                <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="kt_form_1" action="{{ route('parametre.store') }}" method="POST">@csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="libelle" placeholder="Enter le libelle">
                                                </div>
                                            </div>
                                        </div>
                                       <!--  <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="type" placeholder="t">
                                                </div>
                                            </div>
                                        </div> -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="description" placeholder="Enter la">
                                                </div>
                                            </div>
                                        </div>
