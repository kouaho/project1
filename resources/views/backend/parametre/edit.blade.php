...
<html lang="en">
    ...
    <head>
        <base href="../../../">
        <meta charset="utf-8" />
        <title>Bugtrucker | Modifier {{$parametre->libelle}}</title>
                ...
                <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    ...
                                    <a class="btn btn-primary" style="width: 105px;"href="{{ route('parametre.index') }}"><i class="flaticon2-back-1"></i> Back</a>
                                </div>
                                </div>
                                @if ($errors->any())
                                    <div class="kt-portlet__head">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="kt_form_1" form action="{{ route('parametre.update',$parametre->id) }}" method="POST">@csrf
                                    @method('PUT')
                                    ...
                                    <div class="kt-portlet__body"> 
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="type" name="type" placeholder="Enter le libelle" value="{{$parametre->type}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="type" name="libelle" placeholder="Enter le libelle" value="{{$parametre->libelle}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3 col-sm-12">Decription*</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="kt-typeahead">
                                                    <input class="form-control" id="kt_typeahead" type="text" name="description" placeholder="Enter la description" value="{{$parametre->description}}">
                                                </div>
                                            </div>
                                        </div>
