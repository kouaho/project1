...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/animate/animatecss')}}"> 
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/css-hamburgers/hamburgers.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/select2/select2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/front_css/util.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/front_css/main.css')}}">
</head>
<body>
